 ...
 */
contract ZTBEscrowUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // Provide a gap at the end to allow for future storage variable additions safely
    ...
    /**
     * @notice Initializer for the ZTBEscrow Contract
     ...
     * @param _initialOwner Address of the proxy admin/owner
     */
    function initialize(
        address _usdtToken,
     ...
     */
    function commit(uint256 bountyId, bytes32 commitHash, uint256 payloadLength) external payable nonReentrant {
